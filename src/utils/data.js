...
//utility for creating JSON file of country codes

const countryCodes = {};

countriesArray.forEach((item) => (countryCodes[item.alpha3Code] = item.name));

let data = JSON.stringify(countryCodes);

fs.writeFileSync("country-codes.json", data);
